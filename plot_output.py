...
def FullBridgeComparsion():
    ...
    # csv_file2 = "full-bridge-llc-plec-hil.csv"
    # csv_file3 = "full-bridge-llc-plec.csv"
    # csv_file4 = "fullBridgeMatlab.csv"
    csv_file1 = "full-bridge-llc-x30.csv"
    csv_file2 = "Full-bridge-llc-simplified-hil-with-capacitorx30.csv"
    # #csv_file3 = "full-bridge-llc-plec-x30.csv"
    csv_file3 = "Full-bridge-llc-simplified-hil-x30.csv"
    x_col1 = 0
    x_col2 = 0
    x_col3 = 0
    x_col4 = 0
    ...
    # y_col2 = 1
    # y_col3 = 10
    # plot_csv_3columns(csv_file1=csv_file1, csv_file2=csv_file2, csv_file3=csv_file3, x_col1=x_col1, y_col1=y_col1, x_col2=x_col2, y_col2=y_col2, x_col3=x_col3, y_col3=y_col3, title="VCR")    
