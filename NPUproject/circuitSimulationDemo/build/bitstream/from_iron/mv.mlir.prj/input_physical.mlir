module {
  aie.device(npu2) {
    ...
    %switchbox_0_0 = aie.switchbox(%shim_noc_tile_0_0) {
      ...
      %6 = aie.masterset(South : 3, %3)
      %7 = aie.masterset(South : 0, %4) {keep_pkt_header = true}
      %8 = aie.masterset(North : 2, %0)
    ...
    %tile_0_2 = aie.tile(0, 2) {allocation_scheme = "basic-sequential", controller_id = #aie.packet_info<pkt_type = 0, pkt_id = 27>}
    ...
    %tile_1_2 = aie.tile(1, 2) {allocation_scheme = "basic-sequential", controller_id = #aie.packet_info<pkt_type = 0, pkt_id = 27>}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb3
      ...
      aie.dma_bd(%switch_diode_buffer : memref<1792xf32>, 0, 1792) {bd_id = 0 : i32, next_bd_id = 1 : i32}
    ...
    ^bb3:  // pred: ^bb1
      ...
      aie.dma_bd(%A_B_C_D_buffer : memref<5376xf32>, 0, 1680) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%A_B_C_D_con_lock, Release, 1)
      aie.next_bd ^bb1
    ^bb4:  // pred: ^bb2
      aie.use_lock(%A_B_C_D_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%A_B_C_D_buffer : memref<5376xf32>, 1680, 3696) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%A_B_C_D_con_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb5:  // pred: ^bb2
    ...
    ^bb6:  // 2 preds: ^bb4, ^bb7
      ...
      aie.dma_bd(%in_buffer_0 : memref<984xf32>, 0, 492) {bd_id = 3 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%in_buffer_c_lock, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%in_buffer_p_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%in_buffer_0 : memref<984xf32>, 492, 492) {bd_id = 4 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%in_buffer_c_lock, Release, 1)
      aie.next_bd ^bb6
    ^bb8:  // 2 preds: ^bb5, ^bb10
      aie.use_lock(%lock_0_2_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out_buffer_0 : memref<7872xf32>, 0, 3936) {bd_id = 5 : i32, next_bd_id = 6 : i32, packet = #aie.packet_info<pkt_type = 0, pkt_id = 9>}
    ...
    ^bb10:  // pred: ^bb8
      aie.use_lock(%lock_0_2_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out_buffer_0 : memref<7872xf32>, 3936, 3936) {bd_id = 6 : i32, next_bd_id = 5 : i32, packet = #aie.packet_info<pkt_type = 0, pkt_id = 9>}
      aie.use_lock(%lock_0_2, Release, 1)
      aie.next_bd ^bb8
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb3
      ...
      aie.dma_bd(%switch_diode_buffer_debug : memref<1792xf32>, 0, 1792) {bd_id = 0 : i32, next_bd_id = 1 : i32, packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
    ...
    ^bb3:  // pred: ^bb1
      ...
      aie.dma_bd(%A_B_C_D_debug_buffer : memref<5376xf32>, 0, 5376) {bd_id = 1 : i32, next_bd_id = 0 : i32, packet = #aie.packet_info<pkt_type = 0, pkt_id = 7>}
    ...
    %switchbox_0_1 = aie.switchbox(%mem_tile_0_1) {
      ...
      %2 = aie.amsel<2> (0)
      %3 = aie.amsel<3> (0)
      %4 = aie.masterset(South : 1, %1)
      %5 = aie.masterset(South : 3, %3)
