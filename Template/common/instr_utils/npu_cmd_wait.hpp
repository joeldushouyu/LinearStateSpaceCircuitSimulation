...
struct npu_wait_cmd : public npu_cmd{
    ...
    void to_npu(std::vector<uint32_t>& npu_seq){
        ...
        uint32_t ss = (this->wait_row << wait_sync_row_shift) | (this->wait_col << wait_sync_col_shift) | (this->channel_direction << wait_sync_direction_shift);
        ...
        ss = (this->wait_channel << wait_sync_channel_shift) | 0x10100;
