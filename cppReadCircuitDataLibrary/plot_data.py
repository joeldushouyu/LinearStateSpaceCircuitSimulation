...
"Vmout": [14, 1, 2,14,14,14],
"Vp": [9, 2, 7,9,9,9],
"Vs1": [11, 3, 8,11,11,11],
"Vs2": [13, 4, 9,13,13,13],
"VD1": [10, 5, 10,10,10,10],
"VD2": [12, 6, 11,12,12,12],
"AM_D1": [2, 7, 12,2,2,2],
"AM_D2": [3, 8, 13,3,3,3],
"AML1": [1, 10, 14,1,1,1],
"VC1": [8, 9, 6,8,8,8],
...
for lab, index_list in y_labels.items():
    ...
    plot_csv_ncolumns( csv_files=[sim_20,plec_x20, plec_hil_x20,host_sim,host_naive,npu_sim],
                    x_cols= [0,0,0,0,0,0],
                    y_cols= index_list,
                    labels= ["python", "plec", "plec_hil", "c++", "c++naive", "NPU_sim"],
                    y_label= lab
                    )